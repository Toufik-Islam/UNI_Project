...
public class BookedResourcesPanel extends JPanel 
{
    ...
    private void showBookedResourcesPanel() 
	{
        ...
        bookedResourcesModel.addColumn("Category(Class, material etc)");
        bookedResourcesModel.addColumn("Time Slot");
        bookedResourcesModel.addColumn("Reference(Room No etc)");
